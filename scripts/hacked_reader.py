    ...
    def read_records(start_offset=None, end_offset=None):
        ...
        while file.tell() < end_offset:
            if file.readinto(length_bytes) != 8:
                ...
                print("===========================================")
                print("==== CRITICAL ERROR LEAD TO DATA CRASH ====")
                print("**** Failed to read the record size.   ****")
                print("===========================================")
                break
            ...
            if file.readinto(crc_bytes) != 4:
                ...
                print("===========================================")
                print("==== CRITICAL ERROR LEAD TO DATA CRASH ====")
                print("**** Failed to read the start token.   ****")
                print("===========================================")
                break
            # print('aaaaaaa')
            ...
            if file.readinto(datum_bytes_view) != length:
                ...
                print("===========================================")
                print("==== CRITICAL ERROR LEAD TO DATA CRASH ====")
                print("**** Failed to read the record         ****")
                print("===========================================")
                break
            ...
            if file.readinto(crc_bytes) != 4:
                ...
                print("===========================================")
                print("==== CRITICAL ERROR LEAD TO DATA CRASH ====")
                print("**** Failed to read the end token.     ****")
                print("===========================================")
                break 
...
def extract_feature_dict(features, description, typename_mapping):
    ...
    elif True: #isinstance(features, example_pb2.Features):

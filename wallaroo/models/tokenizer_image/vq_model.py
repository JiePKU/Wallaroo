...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, z):
        ...
        return z_q, (vq_loss, commit_loss, entropy_loss, codebook_usage), (perplexity, z, min_encoding_indices)

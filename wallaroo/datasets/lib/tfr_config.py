...
_C.DATASET.TRAIN_DATA.BATCH_SIZE = 4
_C.DATASET.TRAIN_DATA.WORKER_NUM = 4
_C.DATASET.EVAL_DATA = CN()
_C.DATASET.EVAL_DATA.DATA_PATH = []
_C.DATASET.EVAL_DATA.BATCH_SIZE = 4
_C.DATASET.EVAL_DATA.WORKER_NUM = 4
